locals {
  db = flatten([
    for db_key, db in try(var.instance.databases, {}) : {
      ...
      recovery_point_id                                          = try(db.recovery_point_id, null)
      ...
      import                                                     = try(db.import, null)
      threat_detection_policy                                    = try(db.threat_detection_policy, null)
      ...
      identity                                                   = try(db.identity, null)
      secondary_type                                             = try(db.secondary_type, null)
